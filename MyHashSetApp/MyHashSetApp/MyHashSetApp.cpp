...
// MyHashSetApp.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMyHashSetAppApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMyHashSetAppApp::OnAppAbout)
...
// Создание CMyHashSetAppApp

CMyHashSetAppApp::CMyHashSetAppApp() noexcept
{
	...
	SetAppID(_T("MyHashSetApp.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMyHashSetAppApp

CMyHashSetAppApp theApp;


// Инициализация CMyHashSetAppApp

BOOL CMyHashSetAppApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMyHashSetAppDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMyHashSetAppView));
	if (!pDocTemplate)
		return FALSE;
...
int CMyHashSetAppApp::ExitInstance()
{
...
// Обработчики сообщений CMyHashSetAppApp
...
void CMyHashSetAppApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
